...
>>The units are people or adults in the United States.  N is in the millions.
...
>>Resumes have changed over time.
...
>>
Perhaps the race associated with names have changed over time.
The hiring practices of companies might also have changed over time.

> What is one reason why representativeness might not hold?

>>
Is the data representative of the hole population?
Perhaps the CVs were only sent to a small portion of the country.

> What is one reason why unconfoundedness might not hold?

>>
Assignment of treatment should be random.  
Perhaps CVs were also different between black and white names.
...
>>
Prediction table - do not need counterfactual.
Preceptor table only has one outcome.
